...
struct Order orders[300] = {
    ...
    // ATIVOS
    {.id = 18, .user_id = 1, .restaurant_id = 4, .status = STATUS_CONFIRMED, .price = 18.00, .creationDate = 1764345000, .deliveryDate = 0, .address = {.cep = "79152-50", .neighborhood = "Aguas Claras"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Copo 500ml", .price = 18.00, .restaurantId = 4, .amount = 100, .optionCount = 1}, .dishOptionsCount = 1, .dishOptions = {"Morango"}}}},

    {.id = 19, .user_id = 1, .restaurant_id = 0, .status = STATUS_CONFIRMED, .price = 45.00, .creationDate = 1764348000, .deliveryDate = 0, .address = {.cep = "79152-50", .neighborhood = "Aguas Claras"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Pizza Mussarela", .price = 45.00, .restaurantId = 0, .amount = 10, .optionCount = 2}, .dishOptionsCount = 2, .dishOptions = {"Catupiry", "Massa Pan"}}}},
    ...
    {.id = 37, .user_id = 2, .restaurant_id = 0, .status = STATUS_CONFIRMED, .price = 42.00, .creationDate = 1764342000, .deliveryDate = 0, .address = {.cep = "70000-000", .neighborhood = "Asa Norte"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Pizza Calabresa", .price = 42.00, .restaurantId = 0}}}},

    {.id = 38, .user_id = 2, .restaurant_id = 2, .status = STATUS_CONFIRMED, .price = 12.00, .creationDate = 1764345000, .deliveryDate = 0, .address = {.cep = "70000-000", .neighborhood = "Asa Norte"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Misto Quente", .price = 12.00, .restaurantId = 2}}}},

    {.id = 39, .user_id = 2, .restaurant_id = 4, .status = STATUS_CONFIRMED, .price = 18.00, .creationDate = 1764350000, .deliveryDate = 0, .address = {.cep = "70000-000", .neighborhood = "Asa Norte"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Copo 500ml", .price = 18.00, .restaurantId = 4, .amount = 100, .optionCount = 1}, .dishOptionsCount = 1, .dishOptions = {"Leite Ninho"}}}},
    ...
    {.id = 57, .user_id = 3, .restaurant_id = 2, .status = STATUS_CONFIRMED, .price = 24.00, .creationDate = 1764340000, .deliveryDate = 0, .address = {.cep = "72000-000", .neighborhood = "Ceilandia"}, .dishOrdersCount = 2, .dishOrders = {{.dish = {.id = 1, .name = "Misto Quente", .price = 12.00, .restaurantId = 2}}, {.dish = {.id = 1, .name = "Misto Quente", .price = 12.00, .restaurantId = 2}}}},

    {.id = 58, .user_id = 3, .restaurant_id = 3, .status = STATUS_CONFIRMED, .price = 32.00, .creationDate = 1764345000, .deliveryDate = 0, .address = {.cep = "72000-000", .neighborhood = "Ceilandia"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Smash Burger Duplo", .price = 32.00, .restaurantId = 3, .amount = 50, .optionCount = 2}, .dishOptionsCount = 2, .dishOptions = {"Bem Passado", "Guarana"}}}},
    ...
    // ATIVOS
    {.id = 77, .user_id = 4, .restaurant_id = 4, .status = STATUS_CONFIRMED, .price = 45.00, .creationDate = 1764342000, .address = {.cep = "73000-000"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Barca de Acai", .price = 45.00, .restaurantId = 4}}}},

    {.id = 78, .user_id = 4, .restaurant_id = 3, .status = STATUS_CONFIRMED, .price = 32.00, .creationDate = 1764345000, .address = {.cep = "73000-000"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Smash Burger Duplo", .price = 32.00, .restaurantId = 3, .amount = 50, .optionCount = 2}, .dishOptionsCount = 2, .dishOptions = {"Ao Ponto", "Sem Bebida"}}}},

    {.id = 79, .user_id = 4, .restaurant_id = 1, .status = STATUS_CONFIRMED, .price = 89.90, .creationDate = 1764348000, .address = {.cep = "73000-000"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Barca 30 Pecas", .price = 89.90, .restaurantId = 1}}}},
    ...
    {.id = 125, .user_id = 1, .restaurant_id = 4, .status = STATUS_CONFIRMED, .price = 45.00, .creationDate = 1764335000, .address = {.cep = "79152-50", .neighborhood = "Aguas Claras"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Barca de Acai", .price = 45.00, .restaurantId = 4, .amount = 10, .optionCount = 0}}}},

    {.id = 126, .user_id = 2, .restaurant_id = 2, .status = STATUS_CONFIRMED, .price = 24.00, .creationDate = 1764338000, .address = {.cep = "70000-000", .neighborhood = "Asa Norte"}, .dishOrdersCount = 2, .dishOrders = {{.dish = {.id = 1, .name = "Misto Quente", .price = 12.00, .restaurantId = 2, .amount = 10, .optionCount = 0}}, {.dish = {.id = 1, .name = "Misto Quente", .price = 12.00, .restaurantId = 2, .amount = 10, .optionCount = 0}}}},

    {.id = 127, .user_id = 3, .restaurant_id = 0, .status = STATUS_CONFIRMED, .price = 45.00, .creationDate = 1764340000, .address = {.cep = "72000-000", .neighborhood = "Ceilandia"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Pizza Mussarela", .price = 45.00, .restaurantId = 0, .amount = 10, .optionCount = 2}, .dishOptionsCount = 2, .dishOptions = {"Catupiry", "Massa Fina"}}}},
    ...
    {.id = 129, .user_id = 1, .restaurant_id = 0, .status = STATUS_CONFIRMED, .price = 90.00, .creationDate = 1764344000, .address = {.cep = "79152-50", .neighborhood = "Aguas Claras"}, .dishOrdersCount = 2, .dishOrders = {{.dish = {.id = 0, .name = "Pizza Mussarela", .price = 45.00, .restaurantId = 0, .amount = 10, .optionCount = 2}, .dishOptionsCount = 2, .dishOptions = {"Cheddar", "Massa Pan"}}, {.dish = {.id = 0, .name = "Pizza Mussarela", .price = 45.00, .restaurantId = 0, .amount = 10, .optionCount = 2}, .dishOptionsCount = 2, .dishOptions = {"Catupiry", "Massa Pan"}}}},

    {.id = 130, .user_id = 2, .restaurant_id = 1, .status = STATUS_CONFIRMED, .price = 89.90, .creationDate = 1764346000, .address = {.cep = "70000-000", .neighborhood = "Asa Norte"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Barca 30 Pecas", .price = 89.90, .restaurantId = 1, .amount = 5, .optionCount = 0}}}},

    {.id = 131, .user_id = 3, .restaurant_id = 4, .status = STATUS_CONFIRMED, .price = 18.00, .creationDate = 1764347000, .address = {.cep = "72000-000", .neighborhood = "Ceilandia"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Copo 500ml", .price = 18.00, .restaurantId = 4, .amount = 100, .optionCount = 1}, .dishOptionsCount = 1, .dishOptions = {"Leite Ninho"}}}},

    {.id = 132, .user_id = 4, .restaurant_id = 2, .status = STATUS_CONFIRMED, .price = 12.00, .creationDate = 1764348000, .address = {.cep = "73000-000", .neighborhood = "Aguas Lindas"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Misto Quente", .price = 12.00, .restaurantId = 2, .amount = 10, .optionCount = 0}}}},

    {.id = 133, .user_id = 1, .restaurant_id = 3, .status = STATUS_CONFIRMED, .price = 32.00, .creationDate = 1764349000, .address = {.cep = "79152-50", .neighborhood = "Aguas Claras"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 0, .name = "Smash Burger Duplo", .price = 32.00, .restaurantId = 3, .amount = 50, .optionCount = 2}, .dishOptionsCount = 2, .dishOptions = {"Ao Ponto", "Coca-Cola"}}}},

    {.id = 134, .user_id = 2, .restaurant_id = 0, .status = STATUS_CONFIRMED, .price = 42.00, .creationDate = 1764350000, .address = {.cep = "70000-000", .neighborhood = "Asa Norte"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Pizza Calabresa", .price = 42.00, .restaurantId = 0, .amount = 15, .optionCount = 0}}}},

    {.id = 135, .user_id = 3, .restaurant_id = 1, .status = STATUS_CONFIRMED, .price = 26.90, .creationDate = 1764351000, .address = {.cep = "72000-000", .neighborhood = "Ceilandia"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Temaki Salmao", .price = 26.90, .restaurantId = 1, .amount = 20, .optionCount = 1}, .dishOptionsCount = 1, .dishOptions = {"Cream Cheese"}}}},

    {.id = 136, .user_id = 4, .restaurant_id = 4, .status = STATUS_CONFIRMED, .price = 45.00, .creationDate = 1764352000, .address = {.cep = "73000-000", .neighborhood = "Aguas Lindas"}, .dishOrdersCount = 1, .dishOrders = {{.dish = {.id = 1, .name = "Barca de Acai", .price = 45.00, .restaurantId = 4, .amount = 10, .optionCount = 0}}}},
